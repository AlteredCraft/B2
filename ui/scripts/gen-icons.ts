...
// Copyright (c) 2019-2024 The Bootstrap Authors. Licensed under the MIT License; the full
// text ships with the devDependency (ui/node_modules/bootstrap-icons/LICENSE).
//
