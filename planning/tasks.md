...
| **Engine & quality** | property tests for the invariants [#18](https://github.com/AlteredCraft/B2/issues/18) · qmd chunker upgrade [#19](https://github.com/AlteredCraft/B2/issues/19) — **chunker landed 2026-07-13** (`chunk.rs`, [specs/qmd-chunker.md](specs/qmd-chunker.md) Steps 1–2: size-targeted + overlapping + `heading_path`, `ChunkConfig` levers, unit-tested); the real-model eval gate (spec §7, out-of-CI) is the remaining step before close · distance-weighting for `b2 similar` [#20](https://github.com/AlteredCraft/B2/issues/20) |
